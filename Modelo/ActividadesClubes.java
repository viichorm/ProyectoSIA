...
import Excepciones.ActividadNoEncontradaException;
    ...
    public class ActividadesClubes{
        ...
        public static void agregarActividad(ArrayList<ActividadesClubes> actividades, ActividadesClubes nuevaActividad) throws IOException {
            if (nuevaActividad instanceof ActividadesExtraDeportivas) {
                // Si es una actividad extra deportiva, añadir directamente la actividad extra deportiva
                actividades.add((ActividadesExtraDeportivas) nuevaActividad);
            } else {
                // Si no es extra deportiva, simplemente añadir la actividad normal
        ...
        public static void mostrarActividades(ArrayList<ActividadesClubes> actividades) {
            ...
            // Método para agregar actividad desde el menú de consola
    public static void agregarActividadConsola(ArrayList<ActividadesClubes> actividades, BufferedReader buffer) throws IOException {
        ...
        if (esExtra.equals("si")) {
            ...
            nuevaActividad = new ActividadesClubes();
        }
    ...
    // Método para editar actividad desde el menú de consola
    public static void editarActividadConsola(ArrayList<ActividadesClubes> actividades, BufferedReader buffer) throws IOException, ActividadNoEncontradaException {
        System.out.print("Ingrese el ID de la actividad a editar: ");
        int idActividad = Integer.parseInt(buffer.readLine());
    ...
    // Método para eliminar actividad desde el menú de consola
    public static void eliminarActividadConsola(ArrayList<ActividadesClubes> actividades, BufferedReader buffer) throws IOException {
        System.out.print("Ingrese el ID de la actividad a eliminar: ");
        int idActividadEliminar = Integer.parseInt(buffer.readLine());
    ...
    public static void eliminarTodasLasActividades(ArrayList<ActividadesClubes> actividades) {
        if (actividades == null || actividades.isEmpty()) {
            System.out.println("No hay actividades para eliminar.");
            return;
        }
    ...
    public static void mostrarActividadesConsola(ArrayList<ActividadesClubes> actividades) {
        if (actividades.isEmpty()) {
            System.out.println("No hay actividades registradas.");
            return;
        }
